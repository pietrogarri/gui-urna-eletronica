...
class Urna_App(Tk):
    def __init__(self, eleitores, candidatos):
        ...
        tela = Frame(self, highlightbackground="black", highlightthickness=2)
...
class Titulo_GUI(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)

        self.titulo_entry = StringVar()
        self.configure(background="#E8E8E8")

        self.eleitor_display = Label(self, text="Insira um Titulo de Eleitor", font=FONT1, background="#E8E8E8")
        self.eleitor_display.pack(side="top", pady=(85, 35))
        titulo = Entry(self, font=FONT1, textvariable=self.titulo_entry, justify="center", state="disabled",
                       disabledforeground="black")
        titulo.pack()


class Voto_GUI(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        ...
        frame_nome = Frame(self, background="#E8E8E8")
        frame_nome.pack(side="top")

        self.candidato_display = Label(frame_nome, font=FONT1, background="#E8E8E8")
        self.candidato_display.grid(row=1, column=0, pady=(75, 0), padx=100)

        voto_entry = Frame(self, background="#E8E8E8")
        voto_entry.pack(side="bottom")

        digit1_entry = Entry(voto_entry, width=2, font=FONT1, textvariable=self.dgt1, justify="center",
                             state="disabled", disabledforeground="black")
        digit1_entry.pack(side="left", padx=(200, 5), pady=(25, 100))
        digit2_entry = Entry(voto_entry, width=2, font=FONT1, textvariable=self.dgt2, justify="center",
                             state="disabled", disabledforeground="black")
        digit2_entry.pack(side="right", padx=(0, 200), pady=(25, 100))


class Erro_GUI(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)

        self.configure(background="#E8E8E8")

        error_msg1 = Label(self, text="Titulo digitado invalido!!!", font=FONT1, background="#E8E8E8")
        error_msg1.pack(pady=(100, 5))
        error_msg2 = Label(self, text="Pressione 'Confirma' para retornar a tela anterior", font="Arial 12",
                           background="#E8E8E8")
        error_msg2.pack()
